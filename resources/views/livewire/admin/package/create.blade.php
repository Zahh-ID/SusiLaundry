<div class="mx-auto w-full max-w-3xl space-y-6">
    ...
    <div>
        <p class="text-sm font-semibold text-primary">Tambah Paket</p>
        <h1 class="text-3xl font-bold text-slate-900">Buat Paket Baru</h1>
        <p class="text-sm text-slate-500">Sesuaikan nama, deskripsi, dan harga per kilogram.</p>
    </div>
